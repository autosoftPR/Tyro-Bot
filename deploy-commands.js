...
const commands = [
	new SlashCommandBuilder().setName('help').setDescription('Replies with help'),
	...
	new SlashCommandBuilder().setName('developer-ws').setDescription('Replies with developer wesbite'),
]
